...
(variable peso)
(variable edad) ;;aniadimos la variable edad
(variable dosis)
)
...
(cd temperatura normal 36 36.5 37 37.3)   ; he cambiado esto para modificarlo
...
;;nuevas aniadidas por mi:
(cd edad joven 0 0 20 30)        ;menores de 30
(cd edad adulto 25 35 50 60)    ;entre 35 y 50 años
(cd edad anciano 55 65 120 120) ;mayores de 65
)
...
;;aniadidas para la edad:
(regla 5 antecedente edad anciano)
(regla 5 consecuente dosis baja)
(regla 5 explicacion "Si el paciente es anciano, se recomienda una dosis baja por precaución")
...
;;aniadimos la pregunta 3 acerca de la variable que hemos aniadido nueva: edad
(defrule pregunta3
(declare (salience 1))
=>
(printout t "Edad: ")
